...
locals {
  ...
  deskplane_chart_version  = "0.1.0-d976a9b0"
  deskplane_image_tag      = "d976a9b0"
  ...
  values = [yamlencode({
    ...
    catalog = {
      images = [
        ...
        {
          name        = "cua-ubuntu", displayName = "Computer-Use Desktop", image = "${local.deskplane_registry_image}/cua-ubuntu-kasm:d976a9b0"
