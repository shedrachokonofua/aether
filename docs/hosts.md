...
| `tank`         | ARM board    | Talos Linux | Kubernetes worker  | 4GB   | microSD                               | Raspberry Pi 5       | VideoCore VII            | 4 / 4           | 1Gbps   | Raspberry Pi 5      | 10.0.3.23     |
| `dozer`        | ARM board    | Talos Linux | Kubernetes worker  | 4GB   | microSD                               | Raspberry Pi 5       | VideoCore VII            | 4 / 4           | 1Gbps   | Raspberry Pi 5      | 10.0.3.24     |
