...
- [ ] Cloud-audit (vigil) rollout — deployed, soaking ([PLAN](https://gitlab.home.shdr.ch/so/vigil/-/blob/main/PLAN.md))
  - [x] P0 identities/trusts (federated-jwt, AWS/GCP/OCI/TS/Bao legs, negatives verified)
