...
| ClickHouse (`metrics` db) | 365 days | otel fan-out currently DISABLED (2026-07-11 memory_limiter incident — see exploration/telemetry-archive.md); schema/grants in place, Prometheus is the 30d hot path |
