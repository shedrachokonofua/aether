...
| Monitoring Stack        | Niobe   | VM   | 4GB   | 128GB                        | Node             | 4    | None        | Yes           | Prometheus, Grafana, Loki, Tempo, Otel Collector                                                | LIVE        |
...
| AdGuard - Primary       | Oracle  | LXC  | 512MB | 16GB                         | Node             | 2    | None        | Yes           | AdGuard Home, AdGuard DNS, AdGuard Exporter                                                     | PLANNED     |
