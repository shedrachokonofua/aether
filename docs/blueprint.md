...
| Dokploy                | Trinity | VM   | 8GB  | 128GB              | NFS - NVME       | 8    | None        | Yes           | Coolify platform and projects: sandbox, tools(Matrix, OpenWebUI, N8N, Owntracks, Memos, Jupyter, Flowise, etc..) | TODO        |
...
| Network File Server    | Smith   | LXC  | 4GB  | 8TB NVME, 28TB HDD | Node - NVME, HDD | 4    | None        | Yes           | NFS Server, SMB Server                                                                                           | LIVE        |
