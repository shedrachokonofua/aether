...
| GPU Workstation         | Neo     | VM   | 48GB | 1TB                | Node             | 32   | Passthrough | Yes           | Ollama + Models, Docling, ComfyUI, JupyterLab, SwarmUI                                          | LIVE        |
...
| Dokku                   | Neo     | VM   | 8GB  | 256GB              | NFS - NVME       | 8    | None        | Yes           | Multi-tenant PaaS with Terraform support                                                        | LIVE        |
