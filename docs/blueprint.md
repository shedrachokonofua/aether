...
| GPU Workstation         | Neo     | VM   | 64GB | 1TB                | Node             | 32   | Passthrough | Yes           | Ollama + Models                                                                                                       | IN PROGRESS |
| AI Tool Stack           | Neo     | VM   | 8GB  | 128GB              | NFS - NVME       | 4    | None        | Yes           | LiteLLM, SearXNG, Firecrawl, OpenWebUI, LibreChat, MetaMCP, Bytebot                                                   | IN PROGRESS |
...
| Home Automation Stack   | Niobe   | VM   | 2GB  | 32GB               | NFS - NVME       | 4    | None        | Yes           | Home Assistant, Zwave2mqtt, OpenThread Border Router                                                                  | IN PROGRESS |
