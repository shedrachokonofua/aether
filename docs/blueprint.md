...
| Gitlab                 | Trinity | VM   | 8GB  | 128GB              | NFS - NVME       | 8    | None        | Yes           | VCS, CI/CD, Package Registry                                                                                          | IN PROGRESS |
...
| Backup Server          | Smith   | LXC  | 2GB  | 8TB NVME, 28TB HDD | Node - NVME, HDD | 4    | None        | Yes           | Rclone, Proxmox Backup Server                                                                                         | IN PROGRESS |
