...
| Keycloak                | Oracle  | LXC  | 2GB  | 32GB                         | Node             | 2    | None        | Yes           | Identity Provider: OAuth2/OIDC, user management, service accounts                               | PLANNED     |
...
| Wasm Cloud              | Neo     | LXC  | 2GB  | 32GB                         | NFS - NVME       | 2    | None        | Yes           | wasmCloud Host, NATS                                                                            | PLANNED     |
| Smallweb                | Neo     | LXC  | 1GB  | 32GB                         | NFS - NVME       | 2    | None        | Yes           | Smallweb Host                                                                                   | PLANNED     |
