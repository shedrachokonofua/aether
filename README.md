...
1. Initialize the OpenTofu remote backend
...
WAN: Assigned by Bell Gigahub via PPPoE
Bell Gigahub LAN Base: 192.168.2.0/24
OPNsense LAN Base: 10.0.0.0/16
...
| ---- | -------- | ----------------------------------------------------- | ---------------------- | ------- |
| 1    | Ethernet | Bell Gigahub                                          | 10                     | 10Gbps  |
| 2    | Ethernet | Unifi U7 Pro                                          | 20, 30, 40, 50         | 2.5Gbps |
| 3    | Ethernet | Niobe                                                 | 10, 20, 30, 40, 50, 60 | 2.5Gbps |
| 4    | Ethernet | UPS                                                   | 60                     | 100Mbps |
| 5    | Ethernet | Office Switch                                         | 20, 30, 50             | 2.5Gbps |
...
| 5    | Ethernet | Management Port    | 20, 30, 50 | 2.5Gbps |
| 9    | SFP+     | Rack Switch        | 20, 30, 50 | 10Gbps  |
...
| Host    | RAM   | Storage                             | CPU                  | GPU                   | Cores | Threads | vCPUs | Network | Model            | Gigahub IP    | OPNsense IP |
| ------- | ----- | ----------------------------------- | -------------------- | --------------------- | ----- | ------- | ----- | ------- | ---------------- | ------------- | ----------- |
